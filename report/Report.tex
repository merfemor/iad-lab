...
\section{Код}
\lstinputlisting[language=Java]{../src/PointsBean.java}
\lstinputlisting[language=Java]{../src/PointsStorage.java}

\lstinputlisting[language=HTML]{../web/content/main.xhtml}
\lstinputlisting[language=HTML]{../web/content/start.xhtml}

\lstinputlisting[language=Java]{../web/content/date.js}
\lstinputlisting[language=Java]{../web/content/watches.js}

\lstinputlisting[language=XML]{../src/hibernate.cfg.xml}
\lstinputlisting[language=XML]{../web/WEB-INF/faces-config.xml}
\lstinputlisting[language=XML]{../web/WEB-INF/web.xml}
